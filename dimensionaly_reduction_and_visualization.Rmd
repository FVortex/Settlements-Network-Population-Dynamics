...
inds <- seq(1, to = length(village_names), by = 5)
# #par(mfrow = c(2,1))
...
text(x_18_clusts[inds], y_18_clusts[inds], pos = 4, labels = village_names[inds], cex = 0.5, col = 1)
...
text(x_6_clusts[inds], y_6_clusts[inds], pos = 4, labels = village_names[inds], cex = 0.5, col =1)
...
text(tsne$Y[inds,], pos = 4, labels=village_names[inds], col=1, cex = 0.5)
